...
def hidden_1_model(): 		#define hidden_1 model # 0.0056(0.0034)			# great improvement!
	model = Sequential()	# create model
...
def hidden_2_model(): 		#define hidden_2 model # 0.0035(0.0020)			# great improvement!
	model = Sequential()	# create model
...
def hidden_3_model(): 		#define hidden_3 model # 0.0171(0.0264)			# great improvement!
	model = Sequential()	# create model
...
def hidden_4_model(): 		#define hidden_4 model # 0.0112(0.0077)			# great improvement!
	model = Sequential()	# create model
...
def hidden_5_model(): 		#define hidden_5 model # 0.0112(0.0077)			# great improvement!
	model = Sequential()	# create model
